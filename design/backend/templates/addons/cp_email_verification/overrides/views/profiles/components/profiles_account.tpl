...
<div class="control-group">
    <label for="cp_email_verified" class="control-label"> {__('cp_email_verification.cp_email_verified')}:
    </label>
    <div class="controls">
        <input type="checkbox" id="cp_email_verified" name="user_data[cp_email_verified]"
        {if $user_data.cp_email_verified==true}
            checked
        {/if}
        />
    </div>
